...
class SnaiksGame(arcade.Window):
    ...
    def __init__(self):
        super().__init__(
            SCREEN_WIDTH, SCREEN_HEIGHT, "SNAIKS - Snake Battle Royale", resizable=False
        )

        # Set background color (convert BG_COLOR tuple to Arcade format)
        self.background_color = BG_COLOR  # BG_COLOR is already a tuple (20, 30, 40)
    ...
    def on_draw(self):
        ...
        # Performance info disabled for better FPS
        # TODO: Implement cached Text objects for performance display
