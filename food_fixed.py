...
class Food:
    ...
    def _setup_food_properties(self):
        ...
        if self.food_type == "normal":
            ...
            self.color = (255, 100, 100)  # Light red/pink color for health food
            self.effect_description = "Instant healing +3 HP"
    ...
    def draw(self, screen):
        ...
        if self.food_type == "normal":
            ...
            pygame.draw.rect(screen, (255, 255, 255), 
                           (int(self.position.x - cross_size), int(self.position.y - cross_width//2), 
                            cross_size * 2, cross_width))
            # Vertical line
            pygame.draw.rect(screen, (255, 255, 255),
                           (int(self.position.x - cross_width//2), int(self.position.y - cross_size),
                            cross_width, cross_size * 2))
...
def create_food(force_type=None):
    ...
    if random.random() < SPECIAL_FOOD_SPAWN_CHANCE:
        ...
        # Always enable health food for testing the health system
